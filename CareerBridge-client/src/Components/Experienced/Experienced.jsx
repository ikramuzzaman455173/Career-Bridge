      ...
      <>
        <>
          <div className="my-16 text-center">
            <h1 className="text-5xl font-bold mb-7 text-blue-500">
              Experienced Job
            </h1>
          ...
          <div className="grid grid-cols md:grid-cols-2 lg:grid-cols-2 gap-10 ">
            ...
            <div className="flex items-start gap-7 flex-col sm:flex-row md:flex-row lg:flex-row relative bg-cyan-200 ps-8 lg:ps-4 py-10 pe-10 rounded-xl shadow-2xl">
              ...
              <div className="flex-col w-full">
                ...
                <div className="flex justify-start items-center gap-4 sm:gap-5 flex-wrap ">
                  <button
                    type="button"
                    className="px-5 p-2 font-semibold rounded-3xl duration-[800ms] bg-sky-400 hover:bg-blue-700 hover:text-white dark:text-gray-800 text-lg"
                  >
                    Apply
                  </button>
                  <button
                    type="button"
                    className="px-5 py-3 font-semibold rounded-3xl duration-[800ms] bg-purple-400 hover:bg-teal-400 dark:text-gray-800"
                  >
                    Job Details
                  </button>
                </div>
            ...
            <div className="flex items-start gap-7 flex-col sm:flex-row md:flex-row lg:flex-row relative bg-cyan-200 ps-8 lg:ps-4 py-10 pe-10 rounded-xl shadow-2xl">
              ...
              <div className="flex-col w-full">
                ...
                <div className="flex justify-start items-center gap-4 sm:gap-5 my-4 py-2 flex-wrap ">
                  <p>
                    <img
                      className="h-5 w-5"
                      src="../../../public/clock-regular.svg"
